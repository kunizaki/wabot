...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><?php echo _DASHBOARD ?></h1>
                        ...
                        $u = $_SESSION['username'];
						//Numeros Salvos
                        $ns = mysqli_query($conn, "SELECT * FROM nomor WHERE made_by='$u'");
                        $nrow = mysqli_num_rows($ns);
						//mensagens enviadas
                        $ms = mysqli_query($conn, "SELECT * FROM pesan WHERE made_by='$u' and status='SENT'");
                        $mrow = mysqli_num_rows($ms);
						//mensagens agendadas
                        $as = mysqli_query($conn, "SELECT * FROM pesan WHERE made_by='$u' and status='PENDING'");
                        $arow = mysqli_num_rows($as);
                        ?>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <?php echo _SAVED_PHONE ?></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$nrow; ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                <?php echo _WAITING_SCHEDULE ?></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?=$arow?></div>
                        </div>
                        <div class="col-auto">
