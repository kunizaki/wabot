...
if (post("callback")) {
    ...
    mysqli_query($conn, "UPDATE pengaturan SET callback = '$callback' WHERE id='1'");
    toastr_set("success", "Sukses edit callback");
}

if (get("act") == "cn") {
    mysqli_query($conn, "UPDATE pengaturan SET callback = NULL WHERE id='1'");
    toastr_set("success", "Sukses menonaktifkan callback");
    redirect("restapi.php");
}
...
<div class="input url"><label for="OrderLink"><?php echo _APIKEY ?></label><input disabled value="<?= getSingleValDB("account", "username", "$username", "api_key") ?>" placeholder="" name="url" type="url" class="form-control" required id="url"/></div>
<br>
...
<span style="color: #906030">$data</span> <span style="color: #303030">=</span> [
    <span style="background-color: #fff0f0">&#39;api_key&#39;</span> <span style="color: #303030">=&gt;</span> <span style="background-color: #fff0f0">&#39;<?php echo _APIKEY ?>&#39;</span>,
    <span style="background-color: #fff0f0">&#39;sender&#39;</span>  <span style="color: #303030">=&gt;</span> <span style="background-color: #fff0f0">&#39;<?php echo _SENDER_PHONE ?>&#39;</span>,
    <span style="background-color: #fff0f0">&#39;number&#39;</span>  <span style="color: #303030">=&gt;</span> <span style="background-color: #fff0f0">&#39;<?php echo _PHONE ?>&#39;</span>,
    <span style="background-color: #fff0f0">&#39;message&#39;</span> <span style="color: #303030">=&gt;</span> <span style="background-color: #fff0f0">&#39;<?php echo _MESSAGES ?>&#39;</span>
];
...
<span style="color: #906030">$data</span> <span style="color: #303030">=</span> [
    ...
    <span style="background-color: #fff0f0">&#39;url&#39;</span>     <span style="color: #303030">=&gt;</span> <span style="background-color: #fff0f0">&#39;<?php echo _MEDIA_LINK ?>&#39;</span>
];
