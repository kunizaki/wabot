...
$no = 1;
$sender = $_POST['device'];
$res1 = mysqli_query($conn, "SELECT * FROM all_contacts WHERE type = 'Group' AND sender = '$sender'");
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('GroupContacts' . date('d-m-Y H'));
...
header('Content-Disposition: attachment;filename="GroupContacts.xlsx"');
