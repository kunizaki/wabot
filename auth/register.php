...
if (post("username")) {
    ...
    if ($cek->num_rows > 0) {
        ...
        if ($res['status'] == "true") {
            ...
            //var_dump($q2); die;
            toastr_set("success", _REGISTER_SUCCESS);
            redirect("login.php");
        } else {
                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><?php echo _REGISTER_ACCOUNT ?></h1>
                                    </div>
                                    <form class="user" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block" onclick="return confirm('<?php echo _PASSWORD_TEMP_CONFIRM ?>')">
                                            <?php echo _PASSWORD_TEMP_GET ?>
                                        </button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
