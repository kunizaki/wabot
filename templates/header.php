    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-success " id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="numbers.php">
                    ...
                    <span><?php echo _PHONE_NUMBERS ?></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="contacts.php">
                    <i class="fas fa-fw fa-mobile-alt"></i>
                    <span><?php echo _DEVICE_CONTACTS ?></span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="scheduled.php">
                    <i class="fas fa-fw fa-comments"></i>
                    <span><?php echo _SCHEDULED_MESSAGES ?></span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="restapi.php">
                    <i class="fas fa-fw fa-code"></i>
                    <span><?php echo _REST_API ?></span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="navbar-brand-text mx-3"><?php echo _APP_NAME ?></div>
                </a>
                <?php } ?>
